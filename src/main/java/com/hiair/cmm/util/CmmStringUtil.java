...
public class CmmStringUtil {
	...
	/**
	 * <p>문자열을 Byte 단위로 자른다.</p>
	 *
	 * <pre>
	 *   StringUtil.cutStringByte("가나다라마바사" , 0 , 9) = "가나다"
	 * </pre>
	 *
	 * @param date  입력받는 문자열
	 * @return " - "가 추가된 입력문자열
	 */
	public static String cutStringByte(String str, int startIndex, int length) {
        byte[] b1 = null;
        byte[] b2 = null;
        if (str == null) {
        	return "";
	 ...
	 public static void main(String[] args){
	    	String test = "abcdef가나다라마바사";
	    	System.out.println(">>>>" + CmmStringUtil.cutStringByte(test,0,10));
